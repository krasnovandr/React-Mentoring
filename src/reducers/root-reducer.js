import { CHANGE_FILTER, GET_MOVIES, ORDER_CHANGED, ORDER_BY_CHANGED, QUERY_CHANGED, SEARCH_BY_CHANGED } from "../actions";
...
function rootReducer(state = initialState, action) {
    switch (action.type) {
        ...
        case SEARCH_BY_CHANGED:
            return {
                ...state,
                searchCriteria: { ...state.searchCriteria, searchBy: action.searchBy }
            }
